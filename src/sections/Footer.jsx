...
import copyrightSign from "../nike_landing_assets/assets/icons/copyright-sign.svg"
...
const Footer = () => {
  return (
    <footer className="max-container">
      ...
      <dir className="flex justify-between text-white-400 mt-24 max-sm:flex-col max-sm:items-center">
